...
class FrameTwo(Scene):
    def construct(self):
        ...
        condition_1 = MathTex(
            r"\mathcal{C}_1: a_0 \cdot a_1 = 0",
        )
        self.add(condition_1)
        self.wait()
        self.play(condition_1.animate.to_edge(UP))
        self.wait()

        equation_0_1 = MathTex(
            r"0 \cdot 1 = 0",
        )
        equation_0_1.set_color(GREEN).to_edge(UR)
        self.add(equation_0_1)
        self.wait()
        ...
        condition_2 = MathTex(
            r"\mathcal{C}_2: a_0 \cdot (a_0 - 1) = 0",
        )
        ...
        condition_3 = MathTex(
            r"\mathcal{C}_3: a_1 \cdot (a_1 - 1) = 0",
        )
        self.add(condition_3)
        self.wait()
        self.play(condition_3.animate.next_to(condition_2, DOWN))
        self.wait()
